    ...
    <head>
        ...
        <script type="application/javascript">
            ...
            function body_load(){
                ...
                httpRequest.open("POST","bookmeeting_1.action",false);
	    		httpRequest.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	    		httpRequest.send();
          
            }
            function fillEmployees(){
            	selDepartments.onchange = function() {
                ...
                var obj = JSON.parse(msg);
                	for(var i=0;i<obj.length;i++){
                		var item = obj[i];
                        var dep = document.createElement("option");
                        dep.value = item.employeeid;
                        dep.text = item.employeename;
                        selEmployees.appendChild(dep);
                	}
                
                }
            }
                httpRequest.open("POST","bookmeeting_2.action",false);
	    		httpRequest.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	    		httpRequest.send("departmentid="+departmentid);
    ...
    <body onload="body_load()">
        ...
        <div class="page-body">
            ...
            <div class="page-content">
                ...
                <form action="domeeting.action" method="post">
                    <fieldset>
                        <legend>会议信息</legend>
                        <table class="formtable">
                            <tr>
                                <td>会议名称：</td>
                                <td>
                                	<input name="dmt.employeeid" value="${employeeid }" type="hidden"/>
                                    <input type="text" id="meetingname" name="dmt.meetingname" maxlength="20"/>
                                </td>
                            </tr>
                            <tr>
                                <td>预计参加人数：</td>
                                <td>
                                    <input type="text" id="numofattendents" name="dmt.numberofparticipants"/>
                                </td>
                            </tr>
                            <tr>
                                <td>预计开始时间：</td>
                                <td>
                                    <input class="Wdate" type="text" id="starttime" name="dmt.starttime"
                            ...
                            <tr>
                                <td>预计结束时间：</td>
                                <td>
                                    <input class="Wdate" type="text" id="endtime" name="dmt.endtime"
                                   onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
                                </td>
                            </tr>
							<tr>
                            ...
                            <tr>
                                <td>会议说明：</td>
                                <td>
                                    <textarea id="description" rows="5" name="dmt.description"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>选择参会人员：</td>
                                <td>
                                    ...
                                    <div id="divto">
                                        <select id="selSelectedEmployees" name="dmt.selSelectedEmployees" multiple="true">
                                        </select>
                                    </div>
                                </td>
                            </tr>
