                ...
                <form>
                    <fieldset>
                        ...
                        <table class="formtable">
                        	<c:forEach items="${meetingdetail}" var="list">
                            <tr>
								<td>会议名称：</td>
							...
							<tr>
								<td>预计参加人数：</td>
								<td>${list.numberofparticipants }</td>
							</tr>
							...
							<tr>
								<td>会议说明：</td>
								<td><textarea id="description" rows="5" readonly>${list.description }</textarea>
								</td>
							</tr>
							</c:forEach>
                            <tr>
                            ...
                            <tr>
                                ...
                                <c:forEach items="${meetingdetail}" var="list">
                                    <a href="cancelmeeting.action?meetingid=${list.meetingid }" >撤销会议</a>
                                </c:forEach>
